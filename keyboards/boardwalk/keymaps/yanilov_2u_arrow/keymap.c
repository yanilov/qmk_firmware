...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |--------+--------+--------+--------+--------+-----------------+--------+--------+--------+-----------------+--------+--------|
     * | LCTRL  | LGUI   | FN     | RALT   |      SPACE      | FN1  |        FN2        | RGUI   | RCTRL  | LEFT   | DOWN   | RIGHT  |
     * '-----------------------------------------------------------------------------------------------------------------------------'
     */
    [_BASE] = LAYOUT_2u1u2u_arrow(
        ...
        KC_CAPS, KC_LCTL, KC_LALT, KC_LGUI,      KC_SPC,      MO(1),        MO(2),       KC_RGUI, KC_RALT, KC_LEFT, KC_DOWN, KC_RGHT
    ),
    [_FN1] = LAYOUT_2u1u2u_arrow(
        KC_GRV,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_DEL,
        _______, KC_DQUO, _______, _______, KC_LPRN, KC_RPRN, _______, KC_PGUP, KC_UP,  KC_PGDN,  KC_PSCR, KC_SLCK, KC_PAUS, _______,
        _______, KC_QUOT, KC_LBRC, KC_RBRC, _______, _______, KC_MINS, KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, _______, KC_HOME, 
        _______, _______, _______, KC_LCBR, KC_RCBR, _______, _______, KC_MINS, _______, _______, _______, _______, _______, KC_END,
